...
module.exports = async function (bot,message, issueNumber) {
    var reqBody;
    console.log("IN STARTISSUE: issueNumber is "+ issueNumber);
    reqBody = {intent: "ghStartIssueIntent", state: 0, issueNumber: issueNumber};
    try {
